...
taylor = subset(taylor, RESPONSIBLE_COMPANY == "TAYLOR ENERGY" | RESPONSIBLE_COMPANY == "TAYLOR ENERGY COMPANY" | RESPONSIBLE_COMPANY == "TAYLOR ENERGY CO." | RESPONSIBLE_COMPANY == "TAYLOR ENERGY CO. LLC" | RESPONSIBLE_COMPANY == "TAYLOR OIL INC" | RESPONSIBLE_COMPANY == "TAYLOR OIL" | RESPONSIBLE_COMPANY == "TAYLOR ENTERPRISES" | RESPONSIBLE_COMPANY == "TAYLOR ENERGEY" | RESPONSIBLE_COMPANY == "TAYLOR CORP" | RESPONSIBLE_COMPANY == "TAYLOR CORPORATION" | RESPONSIBLE_COMPANY == "TAYLOR")
dim(taylor) #169 137
View(taylor)
